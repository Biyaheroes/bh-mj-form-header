...
module.exports = function build( parameter ){
	...
	return {
		"entry": parameter.test? "./test.js" : "./form-header.support.js",
		...
		"output": {
			"library": parameter.test? "test" : "form-header",
			"libraryTarget": "umd",
			"filename": parameter.test? "test.deploy.js" : "form-header.deploy.js"
		},
